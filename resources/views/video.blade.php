...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <a href="{{ route('video.detail', ['id' => $video->id]) }}" class="block mb-5">
            <div class="bg-white overflow-hidden shadow-md sm:rounded-lg p-6">
                <h3 class="text-xl font-bold">{{ $video->judul }}</h3>
                <small class="text-gray-500 block mb-5">{{ $video->kategori }}</small>
                <div class="text-gray-900 flex">
                    <video class="w-36 h-36 mr-5" controls>
