<x-guest-layout>
    ...
    <div class="h-screen flex">
        ...
        <div class="flex w-1/2 bg-gradient-to-tr from-green-800 to-blue-700 i justify-around items-center w-75">
        <div>
            <h1 class="text-white font-bold text-4xl font-sans">Mental Care</h1>
            <p class="text-white mt-1">Silahkan register untuk melihat profile kamu dan hasil MBTI terbaru.</p>
